...
#define SETTING_SESSION_NAME FName(TEXT("SesssionName"))

UCLASS()
class EXISTSUETEST_API USessionSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable) void CreateSession(int32 NumPublicConnections, bool IsLANMatch, const FString& MapName, const FString& SessionName);
