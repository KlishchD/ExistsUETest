...
void USessionSubsystem::CreateSession(int32 NumPublicConnections, bool IsLANMatch, const FString& MapName, const FString& SessionName)
{
	...
	// This doesn't work in FOnlineSessionNull, so using custom logic
